...
class VOCLike(VOCDetection):
    CLASSES = ['fbox', 'hbox', 'vbox']
    def __init__(self, splits, transform=None, index_map=None, preload_label=True):
        super(VOCLike, self).__init__(os.path.join('~', '.mxnet', 'datasets', 'voc'), splits, transform, index_map, preload_label)
